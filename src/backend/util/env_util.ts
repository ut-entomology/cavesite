...
export function showRequiredEnvVars(errors?: string[] | null) {
  console.log(`
...
export function loadAndCheckEnvVars(): string[] | null {
  const errors: string[] = [];
  dotenv.config(); // load envirnmente variables from '.env'
