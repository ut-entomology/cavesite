<script lang="ts" context="module">
  import type { QueryColumnSpec } from '../../shared/user_query';

  export interface ResultColumnInfo extends QueryColumnSpec {
  ...
  export type ColumnInfoMap = Record<number, ResultColumnInfo>;
</script>
