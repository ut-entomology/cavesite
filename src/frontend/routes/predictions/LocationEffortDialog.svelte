...
>
  <div class="container-fluid location_effort_dialog">
    ...
    <hr />
    <div id="predicted_remaining_taxa">
      <TaxonBarGraph
      ...
      >
        ...
        of this cluster, restricted to the taxa not yet found in the present cave. The
        purple bar for any given taxon depicts the fraction of the total number of
        visits in which the taxon was found. The left column indicates the accuracy <MoreLess
          >with which this chart predicts additional species that can be expected to be
          found at the cave, according to historical data. To determine the accuracy,
          the additional taxa found on the three most recent visits to each cave were
          removed, one cave at a time and one visit at a time, and the taxa found in the
          other caves of the cluster were used to predict the most likely next taxa of
          this cave. The more visits in which those taxa were found, the higher they
          appear in a sort of the taxa. The percentage for the top N taxa indicates the
          average rate at which each next visit to the cave yielded taxa in the top N
          taxa of this sort. <i
            >For example, a top 5 accuracy of 25% would mean that this prediction
            technique correctly predicted 25% of the taxa occurring among the next N
            taxa found in the cave.</i
          > These percentages are independent of the individual taxa and are the same for
          all caves of the cluster.</MoreLess
        >
      </TaxonBarGraph>
    </div>
    ...
    <div id="taxa_in_cave">
      <TaxonBarGraph
        ...
        >This chart shows all the taxa found in this cave, sorted by the number of
        visits in which they were found. It illustrates the frequency of occurrence of
        taxa in the cave rather than the frequency of occurrence of specimens. Each bar
        depicts the fraction of the total number of visits in which a taxon was found..</TaxonBarGraph
      >
    </div>
  </div>
</InfoDialog>
