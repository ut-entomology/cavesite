...
<p>
  ...
  >" link (but not in the above example image) to learn how prediction accuracy is
  assessed and the exact meanings of each of the provided summary measures.
</p>
<ExampleImage
...
<ExampleImage
  src="/predictions/per-cave-graph.png"
  alt="Example of a cave-specific graph"
/>
<p>
  This is a graph of all of the visits (or person-visits) made to the cave. The switch
  button above the graph allows you to select between the graphs of visits and
  person-visits.
</p>
