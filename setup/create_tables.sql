...
create table all_taxa_for_effort (
    ...
    kingdom_visits text not null,
    phylum_names text,
    phylum_visits text not null,
    class_names text,
    class_visits text not null,
    order_names text,
    order_visits text not null,
    family_names text,
    family_visits text not null,
    genus_names text,
    genus_visits text not null,
    species_names text,
    species_visits text not null,
    subspecies_names text,
    subspecies_visits text not null,
